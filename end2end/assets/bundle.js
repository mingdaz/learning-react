...
if (serializedUser) {
    store.dispatch((0, _actions.setUser)(JSON.parse(serializedUser)));
}
...
function create() {
	...
	if (!store) {
		store = (0, _redux.createStore)(_reducer2.default, server ? undefined : window.__PRELOADED_STATE__, (0, _redux.applyMiddleware)(_reduxThunk2.default));
	}
...
/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(23), __webpack_require__(64)(module)))
...
var _rgbReducer = __webpack_require__(71);
...
var _RGB = __webpack_require__(108);
...
exports.default = {
    session: {
        login: function login(username, password) {
            return adapter.post('/session', { username: username, password: password }).then(function (resp) {
...
var _ColorBlock = __webpack_require__(110);
